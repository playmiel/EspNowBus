...
> Current code: queue/retry/timeout, key derivation, PMK/LMK setup for ESP-NOW encryption, HMAC for broadcast/control packets using keyBcast/keyAuth, and a minimal authenticated JOIN request/ack flow (nonceA echoed, nonceB returned) are implemented.
